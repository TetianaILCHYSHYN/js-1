...
let сторона1 = +prompt('Вкажіть довжину однієї сторони прямокутника:');
let сторона2 = +prompt('Вкажіть довжину другої сторони прямокутника:');

let периметр1 = сторона1 *2 + сторона2 *2;
alert (`Периметр прямокутника, якщо одна сторона в нього ${сторона1}, а друга ${сторона2} , становить: ${периметр1}`);
console.log (`Периметр прямокутника = ${периметр1}`);
...
alert (`Якщо радіус кола = ${радіус} , Площа кола = ${площаКола.toFixed(2)}`);
